...
also used appllication/json for the API responses , so you can see the difference between the HTML and JSON responses.

the diffrence between this file and Task6.ts is that this file will return HTML responses also JSON responses, which makes it easier to visualize the output in a web browser.
